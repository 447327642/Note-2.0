...
\\[ \begin{align*}
P(Label_5=T\;|\;Email_5) &= P(Label_5=T)\times\prod P(\omega_i\;|\;Label_5=T) \\
...
\\[ \begin{align*}
P(Label_5=F\;|\;Email_5) &= P(Label_5=F)\times\prod P(\omega_i\;|\;Label_5=F) \\
...
\\[ \begin{align*}
P(Label_6=T\;|\;Email_6) &= P(Label_6=T)\times\prod P(\omega_i\;|\;Label_6=T) \\
...
\\[ \begin{align*}
P(Label_6=F\;|\;Email_6) &= P(Label_6=F)\times\prod P(\omega_i\;|\;Label_6=F) \\
&=\frac{1}{2}\times P(reply=1\;|\;Label_6=T)\times P(to=1\;|\;Label_6=T) \times P(sale=1\;|\;Label_6=T) \\
...
&=\frac{1}{2}\times P(to=1\;|\;Label_7=T)\times P(credit=1\;|\;Label_7=T) \\
&=\frac{1}{2}\times \frac{3+1}{3+2} \times \frac{0+1}{3+2} \\
&=\frac{2}{25}
\end{align*} \\]

\\[ \begin{align*}
P(Label_7=F\;|\;Email_7) &= P(Label_7=F)\times\prod P(\omega_i\;|\;Label_7=F) \\
&=\frac{1}{2}\times P(to=1\;|\;Label_7=F)\times P(credit=1\;|\;Label_7=F) \\
&=\frac{1}{2}\times \frac{0+1}{3+2} \times \frac{2+1}{3+2} \\
&=\frac{3}{50}
\end{align*} \\]
